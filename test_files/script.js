/*
  ...
  2. Create an object named "my_first_object" that contains an array of the key value pairs [id:1 data:"FIRST", id:2 data:"SECOND", id:3 data:"THIRD"].
    2a. This my_first_object will also have a function that will add to the array that you instantiated in problem number 2.
      The function should take in two paramaters. Id:integer, and Data:string. The function should take the paramaters and add them as a key value pair to
  ...
  3. Create another function as a property to my_first_object. When this function is ran it should display the data according to the ID you give it from the array.
    This function should take in as a paramater an id from the my_firt_object array. Print the answer to the console. Only the data should be printed.
    3b. Call the function for every id in your array. No forloop just call the function 8 times seperately.
  ...
  4. create another function that is not an attribute of "my_first_object." This function should take the contents of the my_first_object array that you created and should
      lowercase all of the strings in the data column. This function should take in an array as a paramater. You should name the function "lowercase_array_data()."
      4b. Create a for loop that prints to the console everything in the array data column.

  5. Create a functiont that contains a switch statement. This function should take the array you created for my_first_object and should print the data for any id that is even.
  ...
  6. Add a button to the index.html page.
    6a. Create a function named "create_div_dynamically()." The button should run this function when clicked.
          ...
          iv. When you create the div set a certain size to it so that it is clrealy visible when you click the button.
